...
/************************************************************************/
bool List::GetElem(int i, Coordinate *e)	//获取线性表(顺序表)的指定元素
{
...
/************************************************************************/
int List::LocateElem(Coordinate *e)		//寻找第一个满足e的数据元素的位置
{
...
/************************************************************************/
bool List::PriorElem(Coordinate *currentElem, Coordinate *preElem)  //获取指定元素的前驱
{
	//可以借助之前编译的函数完成操作
...
/************************************************************************/
bool List::NextElem(Coordinate *currentElem, Coordinate *nextElem)  //获取指定元素的后继
{
	int temp = LocateElem(currentElem);
	if (temp == -1)
	{
