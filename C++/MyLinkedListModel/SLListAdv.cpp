...
List::List()
{
	//创建结点
	m_pList = new Node;
	//当data是person类型的时候,直接赋值0就会出问题
	//所以使用DEFAULT进行临时存储
	m_pList->data.name = "DEFAULT";
	m_pList->data.phone = "DEFAULT";
	//或者直接不存储内容
...
/*																		*/
/* 创建日期:2019-03-13								 Author:Cyber Kaka	*/
/************************************************************************/
